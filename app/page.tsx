    ...
    <div>
      ...
      <section className="relative bg-gray-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-28">
          <div className="flex flex-col items-center text-center lg:grid lg:grid-cols-2 lg:text-left lg:items-center gap-12">
            <div className="w-full">
              <div className="inline-flex items-center gap-2 bg-red-600/20 border border-red-500/30 rounded-full px-4 py-1.5 text-sm text-red-400 mb-6">
                <Star className="w-4 h-4 fill-red-400 flex-shrink-0" />
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto justify-center lg:justify-start">
                <Link href="/find-tires" className="w-full sm:w-auto bg-red-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-red-700 transition-colors shadow-lg shadow-red-900/30 text-center">
                  Find My Tires
                </Link>
                <Link href="/appointments" className="w-full sm:w-auto border border-white/30 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 transition-colors text-center">
                  Book Appointment
                </Link>
              </div>
            </div>
            <div className="text-8xl lg:text-9xl text-center select-none hidden lg:block">🛞</div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-red-600 text-white py-4 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <p className="font-bold text-base sm:text-lg leading-snug">
            🎉 Special Offer:{' '}
            <span className="inline-block bg-white/20 px-3 py-0.5 rounded-full mx-1 my-0.5">KWIK20</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {brands.map((brand) => (
              <Link
                ...
                className="bg-white border border-gray-200 rounded-xl px-4 py-4 font-bold text-gray-700 hover:border-red-500 hover:text-red-600 transition-colors shadow-sm text-center"
              >
                {brand}
              </Link>
            ))}
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl sm:text-3xl font-black text-gray-900">Featured Tires</h2>
            <Link href="/tires" className="flex items-center gap-1 text-red-600 font-semibold hover:text-red-700 transition-colors text-sm sm:text-base whitespace-nowrap">
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-black text-center text-gray-900 mb-10">Why Choose Kwik Stop Tires?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-black text-center text-gray-900 mb-10">What Our Customers Say</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {testimonials.map((t) => (
              <div key={t.name} className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                ...
                <p className="text-gray-700 mb-4 italic text-center md:text-left leading-relaxed">"{t.text}"</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 items-center">
            <div className="w-full text-center lg:text-left">
              <h2 className="text-2xl sm:text-3xl font-black mb-6">Visit Our Store</h2>
              <div className="space-y-4 inline-block text-left">
                ...
                <div className="bg-white/10 rounded-xl p-4">
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between gap-8"><span>Mon – Fri</span><span className="text-green-400 font-semibold">8:00 AM – 6:00 PM</span></div>
                    <div className="flex justify-between gap-8"><span>Saturday</span><span className="text-green-400 font-semibold">8:00 AM – 5:00 PM</span></div>
                    <div className="flex justify-between gap-8"><span>Sunday</span><span className="text-red-400 font-semibold">Closed</span></div>
                  </div>
                </div>
              </div>
              <div className="mt-6 flex justify-center lg:justify-start">
                <Link href="/contact" className="inline-block bg-red-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-red-700 transition-colors">
                  Get Directions
                </Link>
              </div>
            </div>
            <div className="w-full bg-gray-800 rounded-xl overflow-hidden" style={{ height: 300 }}>
              <iframe
